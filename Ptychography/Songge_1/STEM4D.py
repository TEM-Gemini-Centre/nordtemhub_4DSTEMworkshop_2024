...
# The center of the new ronchigram should be close to the center pixel
    ...
    def plot_trotters(self, selected_frames = None, plot_constrains = True, skip = 0):       
        ...
        fig, ax = self._init_figure(2,3,(12,6),num='Calibrate rotation phase')
        fig2, ax2 = self._init_figure(2,3,(12,6),num='Calibrate rotation amplitude')
...
class SVD_AC():
    ...
    def plot_corrected_trotters(self,frames,aberrations):
        ...
        fig, ax = self.data4D._init_figure(2,len(self.corrected_trotters), (len(self.corrected_trotters)*2,4),
